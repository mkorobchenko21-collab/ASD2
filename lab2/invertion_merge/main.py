...
where number of users U = 10 and number of films M = 5

we need to get output file with:
    6
    3 3
    2 4
    7 4
...
where user id for comparison is X = 6 (entered by user in termianl)
output is sorted by second column (amount of inversions)
"""
